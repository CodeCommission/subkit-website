      ...
      <LayoutContainer>
        <Helmet htmlAttributes={{ lang: "en" }}>
          ...
          <meta
            ...
            content="GraphQL made easy | subkit.io"
          />
        ...
        <Nav hasScrolled={this.state.hasScrolled}>
          <NavLogoLink href="/">
            <NavLogoImage src="/icon-subkit.svg" alt="icon subkit logo" />
            <NavLogoBrand>SubKit</NavLogoBrand>
          </NavLogoLink>
          <NavItems
          ...
          >
            ...
            <NavItem>
              <NavLink
                href={
                  "https://github.com/CodeCommission/subkit/tree/master/docs"
                }
              >
        ...
        <Footer>
          ...
          <NavItems>
            ...
            <NavItem>
              <NavLink href={"https://github.com/CodeCommission/subkit"}>
