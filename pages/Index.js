    ...
    return (
      <div>
        ...
        <IndexContainer>
          <section id="home">
            <Jumbotron>
              <JumbotronHeaderBig>GraphQL made easy</JumbotronHeaderBig>
              <JumbotronHeaderSmall>
                Productive API for web, mobile and desktop developer
              </JumbotronHeaderSmall>
              <br />
              <br />
              <CTAButton href="https://github.com/CodeCommission/subkit/blob/master/docs/getting-started.md#installation">
                npm install -g subkit
              </CTAButton>
            </Jumbotron>

            <TechStackContainer>
              <a href="getting-started.gif" target="_blank">
              ...
              <div className="wow fadeInLeft animated" data-wow-delay="0.1s">
                <AboutInfoContainer>
                  ...
                  <AboutInfo>
                    <h3>Simplicity</h3>
                    <p>
                      by keeping things simple, SubKit GraphQL-Server is easier
                      to use, easier to contribute to, and more secure.
                    </p>
                  </AboutInfo>
                </AboutInfoContainer>
              </div>
              <div className="wow fadeInLeft animated" data-wow-delay="0.1s">
                <AboutInfoContainer>
                  ...
                  <AboutInfo>
                    <h3>Performance</h3>
                    <p>
                      SubKit GraphQL-Server is well-tested and production-ready
              ...
              <div className="wow fadeInLeft animated" data-wow-delay="0.1s">
                <AboutInfoContainer>
                  ...
                  <AboutInfo>
                    <h3>Experience</h3>
                    <p>
                      Front-end and API-Contract-Driven approach - designed and
                      developed to make front-end and back-end development as
              ...
              <div className="wow fadeInLeft animated" data-wow-delay="0.1s">
                <AboutInfoContainer>
                  ...
                  <AboutInfo>
                    ...
                    <p>
                      All important GraphQL tools to create and manage
                      GraphQL-APIs are build-in and available via CLI.
                    </p>
                  </AboutInfo>
                </AboutInfoContainer>
              </div>
          ...
          <SectionContent id="examples">
            <SectionHeading>
              ...
              <SectionTitleLarge>
                <a
                  href="https://github.com/codecommission/subkit-examples"
                  target="_blank"
                >
                  <i
              ...
              <div className="wow fadeInLeft animated" data-wow-delay="0.1s">
                <AboutInfoContainer>
                  ...
                  <AboutInfo>
                    <h3>
                      <a
                        href="https://subkit-basic.cloud.dropstack.run/graphql"
                        target="_blank"
                      >
                        Basic GraphQL API
                      </a>
              ...
              <div className="wow fadeInLeft animated" data-wow-delay="0.1s">
                <AboutInfoContainer>
                  ...
                  <AboutInfo>
                    <h3>
                      <a
                        href="https://subkit-directives.cloud.dropstack.run/graphql"
                        target="_blank"
                      >
              ...
              <div className="wow fadeInLeft animated" data-wow-delay="0.1s">
                <AboutInfoContainer>
                  ...
                  <AboutInfo>
                    <h3>
                      <a
                        href="https://subkit-todos.cloud.dropstack.run/graphql"
                        target="_blank"
                      >
